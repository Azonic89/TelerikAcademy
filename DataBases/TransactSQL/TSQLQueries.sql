...
--- U should enable CLR if by any chance it isnt!!!!
IF NOT EXISTS (
    SELECT value
...
SELECT * FROM udf_AllMatchingNames('^[oistmiahf]+') WHERE Name = 'Sofia' 
UNION
SELECT * FROM udf_AllMatchingNames('^[oistmiahf]+') WHERE Name = 'Smith' 
UNION
SELECT * FROM udf_AllMatchingNames('^[oistmiahf]+') WHERE Name = 'Rob' 
UNION
SELECT * FROM udf_AllMatchingNames('^[oistmiahf]+') WHERE Name = 'Guy'
GO
