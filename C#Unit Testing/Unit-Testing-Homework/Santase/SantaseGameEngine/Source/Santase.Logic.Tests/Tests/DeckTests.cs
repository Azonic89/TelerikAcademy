namespace Santase.Logic.Tests
{
    ...
    public class DeckTests
    {
        ...
        [Test]
        public void Deck_ShouldReturnADeckObject()
        {
            var newDeckObject = new Deck();
        ...
        [Test]
        public void Deck_ShouldReturnADeckWithTwentyFourCards()
        {
        ...
        [Test]
        public void Deck_ShouldInitializeTrumpCard()
        {
            var newDeckObject = new Deck();
        ...
        [Test]
        public void Deck_TrumpCardShouldBeEqualToTheLastCardInTheDeckWhichIsOnIndexZero()
        {
            var newDeckObject = new Deck();
        ...
        [Test]
        public void Deck_DeckMustHaveOneCardOfEachTypeSuitPair()
        {
